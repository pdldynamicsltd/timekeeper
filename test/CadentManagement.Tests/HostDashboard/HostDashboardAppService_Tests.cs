...
using CadentManagement.MultiTenancy.HostDashboard;
...
namespace CadentManagement.Tests.HostDashboard;
...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(CadentManagementDbContext context, SubscriptionPayment subscriptionPayment)
    {
