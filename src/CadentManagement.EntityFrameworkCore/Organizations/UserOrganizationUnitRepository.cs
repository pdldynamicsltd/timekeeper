...
namespace CadentManagement.Organizations;

public class UserOrganizationUnitRepository : CadentManagementRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<CadentManagementDbContext> dbContextProvider)
