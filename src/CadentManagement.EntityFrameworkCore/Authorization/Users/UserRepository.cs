...
public class UserRepository : CadentManagementRepositoryBase<User, long>, IUserRepository
{
    public UserRepository(IDbContextProvider<CadentManagementDbContext> dbContextProvider)
