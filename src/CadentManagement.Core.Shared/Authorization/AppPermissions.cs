...
public static class AppPermissions
{
    ...
    public const string Pages_Administration_Host_Dashboard_Edit = "Pages.Administration.Host.Dashboard.Edit";
    public const string Pages_Administration_Host_HealthCheck = "Pages.Administration.Host.HealthCheck";

    public const string Pages_Administration_RateLimiting = "Pages.Administration.RateLimiting";
