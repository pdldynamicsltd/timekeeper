...
public class CadentManagementWebMvcModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public CadentManagementWebMvcModule(IWebHostEnvironment env)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(CadentManagementWebMvcModule).GetAssembly());
    }
