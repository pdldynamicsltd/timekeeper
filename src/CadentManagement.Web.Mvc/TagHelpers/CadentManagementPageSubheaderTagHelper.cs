...
using CadentManagement.UiCustomization.Dto;

namespace CadentManagement.Web.TagHelpers;
...
public class CadentManagementPageSubheaderTagHelper : TagHelper
{
    ...
    public CadentManagementPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
    {
