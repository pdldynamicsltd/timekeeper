...
using CadentManagement.Web.Areas.App.Models.CustomizableDashboard;
...
public abstract class CustomizableDashboardControllerBase : CadentManagementControllerBase
{
    ...
    public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
    {
        var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
            ...
            {
                Application = CadentManagementDashboardCustomizationConsts.Applications.Mvc,
                PageId = pageId,
