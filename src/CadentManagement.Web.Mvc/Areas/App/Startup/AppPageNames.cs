...
public class AppPageNames
{
    public static class Common
    {
        ...
        public const string ActiveSessions = "Administration.ActiveSessions";
    }
    ...
    public static class Host
    {
        ...
        public const string HealthCheck = "Administration.HealthCheck";
        public const string Settings = "Administration.Settings.Host";
        public const string RateLimiting = "Administration.RateLimiting";
    ...
    public static class Tenant
    {
        ...
        public const string TasksStatusBoard = "Tasks.StatusBoard";
        public const string TasksPlanner = "Tasks.Planner";
        public const string TodoStatuses = "Tasks.Statuses";
    }
}
