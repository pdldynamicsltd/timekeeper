...
namespace CadentManagement.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultBrand;

public class AppDefaultBrandViewComponent : CadentManagementViewComponent
{
