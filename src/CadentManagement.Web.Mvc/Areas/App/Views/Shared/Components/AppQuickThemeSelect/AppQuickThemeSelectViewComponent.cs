...
namespace CadentManagement.Web.Areas.App.Views.Shared.Components.AppQuickThemeSelect;

public class AppQuickThemeSelectViewComponent : CadentManagementViewComponent
{
