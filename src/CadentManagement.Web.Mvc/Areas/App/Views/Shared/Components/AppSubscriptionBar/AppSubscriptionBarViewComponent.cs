...
namespace CadentManagement.Web.Areas.App.Views.Shared.Components.AppSubscriptionBar;

public class AppSubscriptionBarViewComponent : CadentManagementViewComponent
{
