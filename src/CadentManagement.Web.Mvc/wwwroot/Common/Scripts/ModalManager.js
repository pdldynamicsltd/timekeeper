...
(function ($) {
  ...
  app.ModalManager = (function () {
    ...
    return function (options) {
      ...
      var _selectionRangeTypes = ['text', 'search', 'url', 'tel', 'password'];
      ...
      function _initAndShowModal() {
        ...
        _$modal.on('shown.bs.modal', function () {
          ...
          var $firstInput = _$modal.find('input:not([type=hidden]):first');
          if ($firstInput.length) {
            var input = $firstInput[0];
            input.focus();
            
            if (input.value && input.setSelectionRange && _selectionRangeTypes.indexOf(input.type) > -1) {
