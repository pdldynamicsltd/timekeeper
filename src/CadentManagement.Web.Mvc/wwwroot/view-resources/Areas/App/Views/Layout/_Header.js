(function ($) {
  $(function () {
    ...
    function init() {
      loadNotifications();
      getRecentlyLinkedUsers();
      checkExternalLoginLinkResult();
    }

    function checkExternalLoginLinkResult() {
      var urlParams = new URLSearchParams(window.location.search);
      var linkResult = urlParams.get('linkResult');
      if (!linkResult) return;

      sessionStorage.setItem('externalLoginLinkResult', JSON.stringify({
        linkResult: linkResult,
        linkProvider: urlParams.get('linkProvider') || '',
        linkMergeToken: urlParams.get('linkMergeToken') || '',
        linkExistingEmail: urlParams.get('linkExistingEmail') || '',
      }));
