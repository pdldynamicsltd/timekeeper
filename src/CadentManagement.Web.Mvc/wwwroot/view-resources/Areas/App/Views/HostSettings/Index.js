(function ($) {
  $(function () {
      ...
      _hostSettingsService
        .updateAllSettings({
          ...
          security: {
            ...
            sessionManagement: {
              isEnabled: $('#Setting_SessionManagement_IsEnabled').is(':checked'),
              isSessionFingerprintValidationEnabled: $('#Setting_SessionManagement_FingerprintValidation').is(':checked'),
              sessionFingerprintValidationPolicy: $('#Setting_SessionManagement_FingerprintPolicy').val(),
              sessionAbsoluteTimeoutMinutes: parseInt($('#Setting_SessionManagement_TimeoutMinutes').val()) || 480,
              isSessionRevocationEnabled: $('#Setting_SessionManagement_Revocation').is(':checked'),
            },
    ...
    function toggleSessionManagementDetails() {
      if ($('#Setting_SessionManagement_IsEnabled').is(':checked')) {
        $('#SessionManagementDetails').slideDown('fast');
      } else {
        $('#SessionManagementDetails').slideUp('fast');
      }
    }

    function toggleSessionFingerprintPolicy() {
      if ($('#Setting_SessionManagement_FingerprintValidation').is(':checked')) {
        $('#SessionFingerprintPolicySection').slideDown('fast');
      } else {
        $('#SessionFingerprintPolicySection').slideUp('fast');
      }
    }

    $('#Setting_SessionManagement_IsEnabled').change(function () {
      toggleSessionManagementDetails();
    });

    $('#Setting_SessionManagement_FingerprintValidation').change(function () {
      toggleSessionFingerprintPolicy();
    });
