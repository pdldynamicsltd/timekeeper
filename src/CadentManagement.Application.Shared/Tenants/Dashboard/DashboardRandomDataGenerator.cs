...
using CadentManagement.Tenants.Dashboard.Dto;

namespace CadentManagement.Tenants.Dashboard;
...
public static class DashboardRandomDataGenerator
{
    ...
    public static List<MemberActivity> GenerateMemberActivities()
    {
        return new List<MemberActivity>
            {
                new MemberActivity("Brain", CadentManagementConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "015-boy-6.svg"),

                new MemberActivity("Jane", CadentManagementConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%","017-girl-8.svg"),

                new MemberActivity("Tim", CadentManagementConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "004-boy-1.svg"),

                new MemberActivity("Kate", CadentManagementConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
