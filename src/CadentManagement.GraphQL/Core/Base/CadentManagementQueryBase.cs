...
namespace CadentManagement.Core.Base;

public abstract class CadentManagementQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected CadentManagementQueryBase(string fieldName,
