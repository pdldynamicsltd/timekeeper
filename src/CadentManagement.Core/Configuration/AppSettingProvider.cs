...
using CadentManagement.Authentication;
...
public class AppSettingProvider : SettingProvider
{
    ...
    {
        if (!CadentManagementConsts.AllowTenantsToChangeEmailSettings)
        {
    ...
    private IEnumerable<SettingDefinition> GetHostSettings()
    {
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.RateLimiting.IsEnabled,
                    GetFromAppSettings(AppSettings.RateLimiting.IsEnabled, "false"),
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
            };
    }
        ...
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        CadentManagementConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        return new[]
        {
                new SettingDefinition(
                    GetSettingName(
                        CadentManagementDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        CadentManagementDashboardCustomizationConsts.Applications.Angular,
                ...
                new SettingDefinition(
                    GetSettingName(
                        CadentManagementDashboardCustomizationConsts.Applications.React,
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        {
            DashboardName = CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{CadentManagementDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = CadentManagementDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = CadentManagementDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    CadentManagementDashboardCustomizationConsts.Widgets.Host
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            DashboardName = CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{CadentManagementDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = CadentManagementDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = CadentManagementDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    CadentManagementDashboardCustomizationConsts.Widgets.Tenant
