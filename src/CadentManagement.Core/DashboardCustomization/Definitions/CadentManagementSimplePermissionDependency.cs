...
/// </summary>
public class CadentManagementSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public CadentManagementSimplePermissionDependency()
    {
    ...
    public CadentManagementSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public CadentManagementSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
