...
using CadentManagement.DashboardCustomization.Definitions.Cache;

namespace CadentManagement.DashboardCustomization.Definitions;
...
public class DashboardConfiguration : ITransientDependency
{
        ...
        IAbpSession abpSession)
    {
        ...
        var simplePermissionDependencyForTenantDashboard =
            new CadentManagementSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
        ...
        var generalStats = new WidgetDefinition(
            ...
            "WidgetGeneralStats",
            side: MultiTenancySides.Tenant,
            permissionDependency: new CadentManagementSimplePermissionDependency(
                requiresAll: true,
        ...
        var simplePermissionDependencyForHostDashboard =
            new CadentManagementSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
        ...
        var defaultTenantDashboard = new DashboardDefinition(
            CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            new List<string>
            {
        ...
        var defaultHostDashboard = new DashboardDefinition(
            CadentManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            new List<string>
            {
                    incomeStatistics.Id,
                    hostTopStats.Id,
