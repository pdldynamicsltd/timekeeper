...
public class CadentManagementMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public CadentManagementMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(CadentManagementConsts.LocalizationSourceName, name);
    }
