...
namespace CadentManagement.Authentication.TwoFactor.Google;

public class GoogleAuthenticatorProvider : CadentManagementServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
{
    ...
    public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
    {
        ...
        var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CadentManagement", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
