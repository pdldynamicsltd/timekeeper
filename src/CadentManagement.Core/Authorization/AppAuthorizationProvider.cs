...
public class AppAuthorizationProvider : AuthorizationProvider
{
    ...
    public override void SetPermissions(IPermissionDefinitionContext context)
    {
        ...
        pages.CreateChildPermission(AppPermissions.Pages_Tenant_Dashboard, L("Dashboard"), multiTenancySides: MultiTenancySides.Tenant)
            .CreateChildPermission(AppPermissions.Pages_Tenant_Dashboard_Edit, L("EditingDashboard"), multiTenancySides: MultiTenancySides.Tenant);
        ...
        administration.CreateChildPermission(AppPermissions.Pages_Administration_Host_Dashboard, L("Dashboard"), multiTenancySides: MultiTenancySides.Host)
            .CreateChildPermission(AppPermissions.Pages_Administration_Host_Dashboard_Edit, L("EditingDashboard"), multiTenancySides: MultiTenancySides.Host);
        ...
        var rateLimiting = administration.CreateChildPermission(AppPermissions.Pages_Administration_RateLimiting, L("RateLimiting"), multiTenancySides: MultiTenancySides.Host);
