...
namespace CadentManagement.Authorization.PasswordlessLogin;

public class PasswordlessLoginManager : CadentManagementDomainServiceBase, IPasswordlessLoginManager
{
