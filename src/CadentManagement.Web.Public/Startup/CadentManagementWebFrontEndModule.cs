...
public class CadentManagementWebFrontEndModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public CadentManagementWebFrontEndModule(IWebHostEnvironment env, CadentManagementEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(CadentManagementWebFrontEndModule).GetAssembly());
    }
}
