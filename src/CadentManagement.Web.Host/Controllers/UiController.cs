...
using CadentManagement.Web.Models.Ui;
using CadentManagement.Web.Session;
using System.Threading.Tasks;

namespace CadentManagement.Web.Controllers;

public class UiController : CadentManagementControllerBase
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (_databaseCheckHelper.Exist(_appConfiguration[$"ConnectionStrings:{CadentManagementConsts.ConnectionStringName}"]))
        {
    ...
    public async Task<IActionResult> Login(LoginModel model, string returnUrl = "")
    {
        ...
        using (CurrentUnitOfWork.SetTenantId(loginResult.Tenant?.Id))
        {
