...
[AbpAllowAnonymous]
[DisableAuditing]
public class InstallAppService : CadentManagementAppServiceBase, IInstallAppService
{
    private readonly AbpZeroDbMigrator<CadentManagementDbContext> _migrator;
    ...
    {
        EditAppSettingsjson($"ConnectionStrings:{CadentManagementConsts.ConnectionStringName}", constring);
    }
