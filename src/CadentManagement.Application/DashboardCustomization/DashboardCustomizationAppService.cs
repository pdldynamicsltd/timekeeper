...
using CadentManagement.DashboardCustomization.Dto;

namespace CadentManagement.DashboardCustomization;

[AbpAuthorize]
public class DashboardCustomizationAppService : CadentManagementAppServiceBase, IDashboardCustomizationAppService
{
    ...
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard_Edit, AppPermissions.Pages_Administration_Host_Dashboard_Edit)]
