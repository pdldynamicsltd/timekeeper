...
public class SubscriptionAppService : CadentManagementAppServiceBase, ISubscriptionAppService
{
    ...
    {
        return upgradeAmount < CadentManagementConsts.MinimumUpgradePaymentAmount;
    }
