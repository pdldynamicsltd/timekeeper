...
using CadentManagement.Authorization.Users.Profile.Cache;
...
using CadentManagement.Gdpr;
using CadentManagement.Graphics;
...
[AbpAuthorize]
public class ProfileAppService : CadentManagementAppServiceBase, IProfileAppService
{
    ...
    public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
    {
        ...
        userProfileEditDto.QrCodeSetupImageUrl = userProfileEditDto.IsGoogleAuthenticatorEnabled
            ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CadentManagement",
    ...
    public async Task ChangePassword(ChangePasswordInput input)
    {
        ...
        if (isExternalLoginOnly || await UserManager.CheckPasswordAsync(user, input.CurrentPassword))
        {
