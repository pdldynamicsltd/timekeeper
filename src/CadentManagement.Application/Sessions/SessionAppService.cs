...
public class SessionAppService : CadentManagementAppServiceBase, ISessionAppService
{
        ...
        return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                ...
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CadentManagementConsts.Currency,
                    CurrencySign = CadentManagementConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CadentManagementConsts.AllowTenantsToChangeEmailSettings,
    ...
    private async Task<TenantLoginInfoDto> GetTenantLoginInfo(int tenantId)
    {
        ...
        if (tenant.Edition is SubscribableEdition subscribableEdition)
        {
            tenantLoginInfo.Edition = ObjectMapper.Map<EditionInfoDto>(subscribableEdition);
        }
        else if (tenant.Edition != null)
        {
            tenantLoginInfo.Edition = ObjectMapper.Map<EditionInfoDto>(tenant.Edition);
        }
