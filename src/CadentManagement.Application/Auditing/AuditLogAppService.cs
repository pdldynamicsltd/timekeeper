...
using CadentManagement.Auditing.Exporting;
...
using EntityHistoryHelper = CadentManagement.EntityHistory.EntityHistoryHelper;

namespace CadentManagement.Auditing;

[DisableAuditing]
[AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
public class AuditLogAppService : CadentManagementAppServiceBase, IAuditLogAppService
{
