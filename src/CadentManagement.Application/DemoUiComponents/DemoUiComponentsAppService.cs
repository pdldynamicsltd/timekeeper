...
using CadentManagement.DemoUiComponents.Dto;

namespace CadentManagement.DemoUiComponents;

[AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
public class DemoUiComponentsAppService : CadentManagementAppServiceBase, IDemoUiComponentsAppService
{
