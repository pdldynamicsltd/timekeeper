...
public class CadentManagementAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public CadentManagementAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
