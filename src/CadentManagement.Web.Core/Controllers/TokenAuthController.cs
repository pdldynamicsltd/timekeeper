...
using CadentManagement.Authentication.TwoFactor;
...
using CadentManagement.Web.Authentication.TwoFactor;
...
public class TokenAuthController : CadentManagementControllerBase
{
    ...
    private string EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
    {
        var query = $"userId={userId}&resetCode={passwordResetCode}";
    ...
    public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
    {
        ...
        if (loginResult.User.ShouldChangePasswordOnNextLogin)
        {
            ...
            return new AuthenticateResultModel
            {
                ...
                ReturnUrl = returnUrl,
                c = EncryptQueryParameters(loginResult.User.Id, loginResult.Tenant, loginResult.User.PasswordResetCode)
            };
        }
    ...
    private async Task<User> RegisterExternalUserAsync(ExternalAuthUserInfo externalLoginInfo)
    {
        ...
        await _userManager.AddClaimAsync(user, new System.Security.Claims.Claim(ExternalLoginConsts.ExternalLoginOnlyClaimType, "true"));
    ...
    private async Task<ExternalAuthUserInfo> GetExternalUserInfo(ExternalAuthenticateModel model)
    {
        ...
        if (!ExternalLoginProviderKeyComparer.AreEqual(model.ProviderKey, userInfo.ProviderKey))
        {
