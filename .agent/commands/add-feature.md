...
aspnet-core/src/
  ...
  Core.Shared/Authorization/AppPermissions.cs                        [~] adds Pages_{Feature} constants
  Core/Authorization/AppAuthorizationProvider.cs                     [~] registers permissions
  Core/Localization/CadentManagement/CadentManagement.xml              [~] adds localization keys
  ...
  EntityFrameworkCore/CadentManagementDbContext.cs                    [~] adds DbSet
